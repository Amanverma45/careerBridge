        ...
        <div className="p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#161e31] px-2 text-slate-500">Or continue with</span></div>
            </div> */}

            {/* <button type="button" className="w-full py-3 bg-white text-slate-900 font-medium rounded-xl flex items-center justify-center gap-2 hover:bg-slate-100 transition">
