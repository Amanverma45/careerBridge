...
function Navbar() {
  ...
  return (
    ...
    <nav className="sticky top-4 z-50 w-full md:w-[90%] max-w-[1300px] h-20 mx-auto bg-[#0f172a]/85      backdrop-blur-md rounded-none md:rounded-tl-[60px] md:rounded-br-[60px] shadow-xl text-white">
